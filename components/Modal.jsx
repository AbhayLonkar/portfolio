...
const Modal = ({ togglePopOver }) => {
  return (
    <div className='bg-slate-950/90  absolute -top-3 inset-0  flex justify-center items-center z-50'>
      <div className='p-3 bg-black text-white rounded-2xl w-80 flex flex-col items-center gap-2 mt-10'>
        ...
        <button type='button' onClick={togglePopOver} className='p-2 bg-blue-400 w-30 rounded-full hover:cursor-pointer shadow shadow-blue-400'>Close</button>
      </div>
    </div>
  )
}
