...
const ProjectItem = ({ image, title, subtitle, live, github }) => {
  return (
    <div className='flex flex-col  border-gray-400 hover:border-blue-400 cursor-pointer border self-center rounded-xl p-3 shadow-lg gap-2  md:mx-1 mx-5 md:h-78   '>
      ...
      <div className='flex md:flex-row flex-col justify-center gap-2'>
        <div className='flex justify-center items-center '>
          <img src={image} alt="project image" className='w-90 h-60 object-contain rounded-lg' />
        </div>
        <div className='h-max flex-1' >
          <p className='mt-5 m-2 text-sm'>{subtitle}</p>
