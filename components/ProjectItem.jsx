...
const ProjectItem = ({ image, title, subtitle, live, github, tech }) => {
  return (
    <div className='flex flex-col  border-gray-400 hover:border-blue-400 cursor-pointer border-2 self-center rounded-xl p-3 shadow-lg gap-2  md:mx-1 mx-5 md:h-78   '>
      ...
      <div className='flex md:flex-row flex-col justify-center gap-2'>
        ...
        <div className='h-max flex flex-col' >
          <p className='mt-5 m-2 text-sm md:h-22 overflow-y-auto text-gray-700 dark:text-white'>{subtitle}</p>
          <p className='mt-5 m-2 font-bold text-sm text-gray-700 dark:text-white'>Technologies used: <span>{tech}</span> </p>
